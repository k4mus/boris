...
public class BorisApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(BorisApp.class);

    private final Environment env;

    public BorisApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(BorisApp.class);
